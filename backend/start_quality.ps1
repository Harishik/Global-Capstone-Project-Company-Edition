# Intellecta RAG Backend - Quality Mode Startup Script (PowerShell)
# Uses LLaMA 3.2 8B with chain-of-thought prompts for better responses

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  Intellecta RAG Backend - Quality Mode" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
# Start the backend
Write-Host ""
Write-Host "Starting FastAPI server in Quality Mode..." -ForegroundColor Green
